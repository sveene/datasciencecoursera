## Extract the data and unzip 
fileName <- "UCIdata.zip"
url <- "http://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
dir <- "UCI HAR Dataset"

# Verify if the file is downloaded. If file does not exist, download to working directory.
if(!file.exists(fileName)){
        download.file(url,fileName, mode = "wb") 
}

# Verify for file unzip. If the directory does not exist, unzip the downloaded file.
if(!file.exists(dir)){
